...
function About() {
  return (
    <main className={styleabout.about}>
      ...
      <p className={styleabout.texts}>
        {' '}
        I am a full stack web developer who loves building things. Helping people to have a great experience while navigating a website is a must. Providing
